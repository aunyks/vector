...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>HOW TO PLAY</div><p>The goal of Vector is to stop blocks from leaving the inside of the outer gray hexagon.</p><p>" + (settings.platform != 'mobile' ? 'Press the right and left arrow keys' : 'Tap the left and right sides of the screen') + " to rotate the Hexagon</p><p>Clear block, get points, and make a Vector by making 3 or more blocks of the same color touch!</p><p>Time left before your combo streak disappears is indicated by <span style='color:#f1c40f;'>the</span> <span style='color:#e74c3c'>colored</span> <span style='color:#3498db'>lines</span> <span style='color:#ffa500'>on</span> the outer hexagon</p> <hr> <p id = 'afterhr'></p> By <a href='https://aunyks.github.io/' target='_blank'>Gerald Nash</a><br><!--Find Vector on <a href = 'https://itunes.apple.com/us/app/id903769553?mt=8' target='_blank'>iOS</a> & <a href ='https://play.google.com/store/apps/details?id=com.Vector.Vector' target='_blank'>Android</a>--><!--More @ the <a href ='http://Vector.github.io/' target='_blank'>Vector Website</a>-->");
	if (gameState == 1) {
		pause();
	}
